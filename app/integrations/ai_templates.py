...
def exercises_template():
    ...
    Given a document content, your task is to create well-structured exercises to help students learn the material.
...
def flashcards_template():
    ...
    Your task is to generate {flashcards_count} high-quality flashcards from a given document or text. Each flashcard should test understanding of the key concepts, definitions, examples, and relationships in the material.
